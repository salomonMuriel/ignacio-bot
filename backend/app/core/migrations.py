...
class MigrationRunner:
    ...
    def create_migration_table(self) -> None:
        ...
        try:
            ...
            logger.info(
                "Please create the migration table manually in Supabase SQL Editor:"
            )
            print(
                """
    ...
    def get_migration_files(self) -> list[Path]:
        ...
        return sorted([f for f in self.migrations_dir.glob("*.sql") if f.is_file()])
    ...
    def print_migration_status(self) -> None:
        ...
        if pending_migrations:
            ...
            for migration_file in pending_migrations:
                ...
                logger.info(
                    "After running the migration, execute this to mark it as applied:"
                )
                logger.info(
                    f"INSERT INTO schema_migrations (migration_name) VALUES ('{migration_file.name}');"
                )
                logger.info("")
        else:
