...
export default function AdminPage() {
      ...
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--ig-bg-gradient)' }}>
        <div className="text-center p-8 rounded-xl glass-surface" style={{
          ...
          <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center" style={{
            ...
            <svg className="w-8 h-8" fill="currentColor" style={{ color: 'var(--ig-text-accent)' }} viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--ig-bg-gradient)' }}>
      {/* Header */}
      <div className="border-b glass-surface" style={{
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{
                ...
                <svg className="w-6 h-6" fill="currentColor" style={{ color: 'var(--ig-dark-primary)' }} viewBox="0 0 24 24">
                  <path d="M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M12,7C13.4,7 14.8,8.6 14.8,10V11.5C15.4,11.5 16,12.4 16,13V16C16,17.4 15.4,18 14.8,18H9.2C8.6,18 8,17.4 8,16V13C8,12.4 8.6,11.5 9.2,11.5V10C9.2,8.6 10.6,7 12,7M12,8.2C11.2,8.2 10.5,8.7 10.5,10V11.5H13.5V10C13.5,8.7 12.8,8.2 12,8.2Z" />
                </svg>
              </div>
              <div>
                <h1 className="text-xl font-semibold" style={{ color: 'var(--ig-text-primary)' }}>
                  Admin Dashboard
                </h1>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{
                ...
                <svg className="w-4 h-4" fill="currentColor" style={{ color: 'var(--ig-text-accent)' }} viewBox="0 0 24 24">
            ...
            {tabs.map((tab) => (
              <button
                ...
                style={{
                  ...
                  boxShadow: activeTab === tab.id ? 'var(--ig-shadow-md)' : 'none'
                }}
              >
                {tab.icon}
                <span>{tab.label}</span>
