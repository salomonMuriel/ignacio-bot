      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            >
              Let's set up your project so Ignacio can provide you with the most
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: 'var(--ig-text-muted)' }}
                >
                  A short description to help Ignacio understand your project's
                  purpose
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onFocus={e =>
                      (e.target.style.borderColor = 'var(--ig-border-accent)')
                    }
                    onBlur={e =>
                      (e.target.style.borderColor = 'var(--ig-border-primary)')
                    }
                  >
          ...
          >
            ...
            >
              <li>
                • Your project will be created and set as your active project
              </li>
              <li>
                • You'll be taken to the chat interface to start talking with
                Ignacio
              </li>
              <li>
                • Ignacio will use this project context to provide relevant
                advice
              </li>
              <li>
                • You can create additional projects and switch between them
                anytime
              </li>
            </ul>
          </div>
