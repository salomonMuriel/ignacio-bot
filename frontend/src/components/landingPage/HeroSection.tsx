        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center lg:text-left space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl lg:text-7xl font-bold text-ignacio-text-primary leading-tight  text-white">
                  Meet{' '}
                  <span
                    className="bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 
          -  bg-clip-text text-transparent"
                ...
                <p className="text-xl lg:text-2xl text-ignacio-text-secondary leading-relaxed max-w-2xl  text-white">
                  Your AI-powered project development assistant. Get expert
                  guidance, strategic insights, and personalized support to turn
