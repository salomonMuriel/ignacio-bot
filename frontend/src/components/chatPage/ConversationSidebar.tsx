...
export default function ConversationSidebar({
  ...
  return (
    <div
      className="w-80 flex flex-col h-full glass-surface"
      style={{
    ...
    >
      ...
      <div
        ...
        style={{ borderBottom: '1px solid var(--ig-border-primary)' }}
      >
        <div className="flex items-center space-x-3 mb-4">
          <div
            className="w-8 h-8 rounded-lg glass-surface-light flex items-center justify-center"
            style={{
        ...
        {activeProject && (
          <div
            className="glass-surface-light rounded-xl p-4 relative"
            style={{
              boxShadow: 'var(--ig-shadow-sm)',
            }}
          >
      ...
      <div className="flex-1 overflow-y-auto">
        {conversations.length === 0 ? (
          ...
          >
            <div
              className="glass-surface-light rounded-xl p-6"
              style={{
                boxShadow: 'var(--ig-shadow-sm)',
              }}
            >
              <div
                className="w-12 h-12 mx-auto mb-4 rounded-full glass-surface flex items-center justify-center"
                style={{
                  boxShadow: 'var(--ig-shadow-sm)',
                }}
              >
            ...
            {conversations.map(conversation => {
              ...
              return (
                  ...
                  style={{
                    ...(isActive
                      ? {
                          ...
                          boxShadow:
                            'var(--ig-shadow-md), var(--ig-shadow-glow)',
                ...
                >
                  ...
                  {isActive && (
                    <div
                      className="absolute left-0 top-1/2 w-1 h-8 rounded-r-full transform -translate-y-1/2"
                      style={{
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        {isActive && (
                          <span
                            className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium ml-2"
                            style={{
                              background: 'var(--ig-accent-gradient)',
      ...
      <div
        ...
        style={{ borderTop: '1px solid var(--ig-border-primary)' }}
      >
        <button
          ...
          onMouseEnter={e => {
            ...
            target.style.boxShadow =
              'var(--ig-shadow-lg), var(--ig-shadow-glow-accent)';
