  ...
  return (
    ...
    >
      ...
      >
        {/* Ignacio Avatar */}
        <div
          className="w-16 h-16 mx-auto mb-6 rounded-full glass-surface-light flex items-center justify-center overflow-hidden"
          style={{
        ...
        <p className="mb-4" style={{ color: 'var(--ig-text-secondary)' }}>
          I'm here to help you develop your project:{' '}
          <strong style={{ color: 'var(--ig-text-accent)' }}>
            {activeProject?.project_name}
          </strong>
        </p>
        <p className="mb-6" style={{ color: 'var(--ig-text-secondary)' }}>
          Ask me anything about marketing, technical implementation, business
          strategy, or any other aspect of your project. I can also help you
          with:
        </p>
        <ul
