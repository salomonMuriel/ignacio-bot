...
export default function ChatHeader({ activeConversation }: ChatHeaderProps) {
  ...
  return (
    <div
      className="p-6 flex-shrink-0 glass-surface"
      style={{
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              <div
                className="w-12 h-12 rounded-xl glass-surface-light flex items-center justify-center overflow-hidden"
                style={{
                  boxShadow:
                    'var(--ig-shadow-md), var(--ig-shadow-glow-accent)',
                }}
              >
                <img
                  src={ignacioAvatar}
                ...
                <g transform="translate(29 33)">
                  <g transform="translate(6, 9) rotate(3 21 21)">
                    <g transform="translate(0 2)">
                      <path
                        d="M8 8.36S8 4 12 4s4 4.36 4 4.36v2.91s0 .73-.67.73c-.66 0-.66-2.9-3.33-2.9S9.33 12 8.67 12C8 12 8 11.27 8 11.27v-2.9ZM26 8.36S26 4 30 4s4 4.36 4 4.36v2.91s0 .73-.67.73c-.66 0-.66-2.9-3.33-2.9S27.33 12 26.67 12c-.67 0-.67-.73-.67-.73v-2.9Z"
                        fill="#ffffff"
                      />
                    </g>
                    <g transform="translate(6 26)">
                      <path
                        d="M15.5 10c-5.07 0-9.3-5.23-8.37-5.88.93-.65 3.45 2.15 8.37 2.15 4.92 0 7.44-2.88 8.37-2.15.93.73-3.3 5.88-8.37 5.88Z"
                        fill="#ffffff"
                      />
                    </g>
                  </g>
